...
public class ServiceFragmentExpandableListViewBaseAdapter extends BaseExpandableListAdapter {
    ...
    public ServiceFragmentExpandableListViewBaseAdapter(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView txtListChild1 = (TextView) convertView.findViewById(R.id.service_fragment_child_list_item_tv1);
        TextView txtListChild2 = (TextView) convertView.findViewById(R.id.service_fragment_child_list_item_tv2);
